...
<nav id="sidebar-wrapper">
    ...
    <!-- Header -->
    <header id="top" class="header9">
        <div class="text-vertical-center">
            <h1>Messages reçus</h1>
            <br><br><br><br>
             <a href="#about" class="btn btn-dark btn-lg">Lire</a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<table id="01" cellpadding="15" cellspacing="10">
            <tr>
	            ...
	            <th width="">Email</th>
	            <th width="">Message</th>
	            <th width="">Suppression</th>
	       </tr>
		<?php
			$conn = mysqli_connect('localhost', 'root', '', 'my_event');
			$req = mysqli_query($conn, "SELECT * FROM contact ORDER BY id DESC");
			if ($req)
				{
					while($data = mysqli_fetch_assoc($req))
                        {
	                        echo "<tr><td>" . $data['nom'] . "</td><td>" . $data['email'] . "</td><td>" . $data['message'] ."</td><td style='text-align:center;'><button style='text-align:center;'>X</button></td></tr>";
                        }
				}
		?>
		</table></div>
