...
<body>
    ...
    <header id="top" class="header4">
        <div class="text-vertical-center">
            <h1>Événements professionnels</h1>
            <br><br><br><br>
...
<br><br><br><br><br><br>
		...
		<?php
			...
			{
				$req = mysqli_query($conn, "SELECT * FROM even WHERE ville = '".$_GET['button']."' AND type = '2'");
			}
			else
			{
				$req = mysqli_query($conn, "SELECT * FROM even WHERE type = '2'");
			}
			if ($req)
				{
